{
  ...
  new(
    ...
    yaxes: [
      ...
      self.yaxe(if formatY2 != null then formatY2 else format, min, max, decimals=if y_axis_decimals != null then y_axis_decimals else decimals, logBase=logBase2Y, label=labelY2),
    ],
    xaxis: {
      show: show_xaxis,
      mode: x_axis_mode,
